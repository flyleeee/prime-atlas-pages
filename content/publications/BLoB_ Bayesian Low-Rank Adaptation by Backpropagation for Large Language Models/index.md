...
abstract: Large Language Models (LLMs) often suffer from overconfidence during
  ...
  Backpropagation (BLoB), an algorithm that continuously and jointly adjusts
  both the mean and covariance of LLM parameters throughout the whole
  fine-tuning process. Our empirical results verify the effectiveness of BLoB in
  terms of generalization and uncertainty estimation, when evaluated on both
...
summary: Advances in Neural Information Processing Systems (NeurIPS), 2024
